...
export const Youtube = ({ size = 24, color = "currentColor", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M2.5 7.1C2.5 7.1 2 9.5 2 12c0 2.5.5 4.9.5 4.9 0 0 1.5 2.1 4.5 2.1 3.5 0 8 0 8 0s4.5 0 8 0c3 0 4.5-2.1 4.5-2.1.08-2.4.08-4.8 0-7.2 0 0-1.5-2.1-4.5-2.1-3.5 0-8 0-8 0s-4.5 0-8 0C2.5 7.1 2.5 7.1 2.5 7.1z"/>
